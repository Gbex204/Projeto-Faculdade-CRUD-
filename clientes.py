...
def cad():
    ...
    print_cor("Cadastro concluido!", CorVerde)
...
def excluirDic():
    ...
    print('\n')
    opcaoExcluir = input('Certeza que deseja apagar este cadastro? (S/N)\n•')
...
def menuClientes():
    while True:
        ...
        print("=" * 55)
        print("[1] MenuClientes | Cadastrar Clientes")
        print("[2] MenuClientes | Listar Clientes")
        print("[3] MenuClientes | Editar Cadastros")
        print("[4] MenuClientes | Excluir Cadastros")
